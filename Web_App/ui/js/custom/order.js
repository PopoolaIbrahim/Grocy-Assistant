...
$("#addMoreButton").click(function () {
    ...
    $(".product-box-extra .product-total").last().text(window.groceryApp.formatPrice(0));
});
...
$(document).on("change", ".cart-product", function (){
    ...
    $(this).closest('.row').find('#product_price').val(window.groceryApp.formatPrice(price));
    calculateValue();
});
...
$("#saveOrder").on("click", function(){
    ...
    requestPayload.grand_total = window.groceryApp.formatPrice(requestPayload.grand_total);
